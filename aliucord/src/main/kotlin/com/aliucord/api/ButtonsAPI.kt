...
public object ButtonsAPI {
    /**
     * Stores data about a button
     */
    public data class ButtonData(val label: String, val style: ButtonStyle, val onPress: (Message, FragmentActivity) -> Unit)
