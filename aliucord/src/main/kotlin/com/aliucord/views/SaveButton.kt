...
public class SaveButton(context: Context) : LinearLayout(context) {
    init {
        val saveButton = FloatingActionButton(context).apply {
            setImageDrawable(ContextCompat.getDrawable(context, R.e.icon_save))
            backgroundTintList = ColorStateList.valueOf(
                context.resources.getColor(R.c.brand, context.theme)
            )
        }
