...
internal class FailedPluginWidget(
    ctx: Context,
    private val file: File,
    private val reason: Any,
    onDelete: () -> Unit
) : LinearLayout(ctx), View.OnClickListener {
    ...
    private fun configure() {
        ...
        mTextView.text = if (isExpanded) {
            fullReason ?: (reason as Throwable).stackTraceToString().also { fullReason = it }
        } else {
            shortReason
        }
    }
